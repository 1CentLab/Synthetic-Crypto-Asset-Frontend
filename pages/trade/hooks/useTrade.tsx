...
const useTrade = () => {
  ...
  const approveTokens = useCallback(async () => {
    ...
    sca
      .increaseAllowance(connectedWallet, tokenAddr.pair, liquidAmount.amount0.toString())
    ...
    usd
      .increaseAllowance(connectedWallet, tokenAddr.pair, liquidAmount.amount1.toString())
      .then((result: TxResult) => {
        setBalanceInfo((prevState) => ({
          ...prevState,
  ...
  const addLiquid = useCallback(async () => {
    ...
    pair
      .add_liquid(connectedWallet, liquidAmount.amount0.toString(), liquidAmount.amount1.toString())
      .then((result: TxResult) => {
        console.log(result);
      })
      .catch((error: any) => {
